...
**Berekening "keer insmeren" — capaciteit van de geleverde navulling, NIET seizoens-verbruik:**
- Formule: \`liters_F30 × 850 + liters_F50 × 450\`. Punt.
- Het is wat de klant maximaal uit de FLES haalt — niet "hoeveel insmeer-momenten verwachten we dit seizoen".
- Voorbeelden:
  - 3L F50 → 3 × 450 = **1.350** keer insmeren
  - 4L F30 + 4L F50 → 4×850 + 4×450 = **5.200** keer insmeren
  - 6L F50 → 6 × 450 = **2.700** keer insmeren
- Afronden naar honderdtallen is prima ("ongeveer 1.400 keer insmeren"). Maar niet zomaar een getal verzinnen.
...
**Voorbeeld goed:**
> Voor een basisschool met 175 kinderen die gelijktijdig buiten spelen. Drie dispensers met schoollogo dekken deze groep goed af over de school met 3 verdiepingen. Met 6L navulling in totaal is er ruim voldoende voorraad voor het hele seizoen — dat geeft zo'n 2.700 keer insmeren. Inclusief gratis verzending.
