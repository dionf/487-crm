 ...
 * @returns {Promise<{ ai_message: string, quote_state: object, history: Array, raw?: string, error?: string }>}
 */
export async function generateOrRefine({ conversationData, history, userMessage }) {
