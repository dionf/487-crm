...
function companyRow(record) {
  ...
  return {
    ...
    "Current customer": p.hs_current_customer || "",
    "Total revenue": p.total_revenue || "",
    "Number of times contacted": p.num_contacted_notes || "",
    "Number of sales activities": p.num_notes || "",
    "Last contacted": p.notes_last_contacted || "",
    "Last activity date": p.notes_last_updated || "",
    "Last sales activity date": p.hs_last_sales_activity_timestamp || "",
    "Last sales activity type": p.hs_last_sales_activity_type || "",
    "Last outgoing email date": p.hs_last_logged_outgoing_email_date || "",
    "Sales email last replied": p.hs_sales_email_last_replied || "",
    "Number of form submissions": p.num_conversion_events || "",
    "First conversion": p.first_conversion_event_name || "",
    "First conversion date": p.first_conversion_date || "",
    "Recent conversion": p.recent_conversion_event_name || "",
    "Recent conversion date": p.recent_conversion_date || "",
    "Original traffic source": p.hs_analytics_source || "",
    "Latest traffic source": p.hs_analytics_latest_source || "",
    "Record source": p.hs_object_source_label || "",
    "Record source detail 1": p.hs_object_source_detail_1 || "",
    "Record source detail 2": p.hs_object_source_detail_2 || "",
...
function contactRow(record, companiesById, subscriptionStatuses) {
  ...
  return {
    ...
    "Current customer": p.hs_current_customer || "",
    "Total revenue": p.total_revenue || "",
    "Total current orders": p.total_number_of_current_orders || "",
    "First order closed date": p.hs_first_order_closed_date || "",
    "Recent closed order date": p.hs_recent_closed_order_date || "",
    "Last order date": p.last_order_date || "",
    "Last order status": p.last_order_status || "",
    "Last order number": p.last_order_order_number || "",
    "Last order value": p.last_order_value || "",
    "Last product bought": p.last_product_bought || "",
    "Last products bought": p.last_products_bought || "",
    "Last SKUs bought": p.last_skus_bought || "",
    "Number of times contacted": p.num_contacted_notes || "",
    "Number of sales activities": p.num_notes || "",
    "Last contacted": p.notes_last_contacted || "",
    "Last activity date": p.notes_last_updated || "",
    "Last sales activity date": p.hs_last_sales_activity_timestamp || "",
    "Last sales activity type": p.hs_last_sales_activity_type || "",
    "Sales email last replied": p.hs_sales_email_last_replied || p.hs_email_last_reply_date || "",
    "Sales email last opened": p.hs_sales_email_last_opened || "",
    "Sales email last clicked": p.hs_sales_email_last_clicked || "",
    "Marketing emails opened": p.hs_email_open || "",
    "Marketing emails clicked": p.hs_email_click || "",
    "Marketing emails replied": p.hs_email_replied || "",
    "Last marketing email open": p.hs_email_last_open_date || "",
    "Last marketing email click": p.hs_email_last_click_date || "",
    "Number of form submissions": p.num_conversion_events || "",
    "First conversion": p.first_conversion_event_name || "",
    "First conversion date": p.first_conversion_date || "",
    "Recent conversion": p.recent_conversion_event_name || "",
...
async function main() {
  ...
  const companyProperties = [
    "name", "domain", "city", "email", "phone", "website", "address", "zip", "country", "industry",
    "lifecyclestage", "hs_current_customer", "total_revenue", "num_contacted_notes", "num_notes",
    "notes_last_contacted", "notes_last_updated", "hs_last_sales_activity_timestamp", "hs_last_sales_activity_type",
    "hs_last_logged_outgoing_email_date", "hs_sales_email_last_replied", "num_conversion_events",
    "first_conversion_event_name", "first_conversion_date", "recent_conversion_event_name", "recent_conversion_date",
    "hs_analytics_source", "hs_analytics_latest_source", "hs_object_source_label", "hs_object_source_detail_1",
    "hs_object_source_detail_2", "createdate", "hs_lastmodifieddate",
  ];
