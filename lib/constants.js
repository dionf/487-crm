...
export const LEAD_STATUSES_487 = [
  ...
  { id: "geen_lead", label: "Geen lead", color: "zinc" },
];

// HipHot pipeline
export const LEAD_STATUSES_HIPHOT = [
  { id: "prospect", label: "Prospect", color: "slate" },
  { id: "nieuwe_aanvraag", label: "Nieuwe Aanvraag", color: "gray" },
  { id: "terugbellen", label: "Terugbellen", color: "amber" },
...
export function getLeadStatuses(tenant) {
  ...
  if (t === "hiphot") return LEAD_STATUSES_HIPHOT;
...
export const INDUSTRIES = [
  { id: "scholen", label: "Scholen / onderwijs" },
  { id: "bouw", label: "Bouw / buitenwerk" },
  { id: "horeca", label: "Horeca / evenementen" },
  { id: "zorg", label: "Zorg / kinderopvang" },
  { id: "sport", label: "Sport / recreatie" },
  { id: "overheid", label: "Overheid / gemeenten" },
...
export const SOURCES = [
  ...
  { id: "zonvenant_partners", label: "Zonvenant partners" },
  { id: "overig", label: "Overig" },
];
...
export const STATUS_COLORS = {
  ...
  terugbellen: { bg: "bg-amber-100", text: "text-amber-700", dot: "bg-amber-400" },
  ...
  // Beide tenants — geen lead (servicevraag, spam, sollicitatie etc)
  geen_lead: { bg: "bg-zinc-100", text: "text-zinc-600", dot: "bg-zinc-400" },
};
